...
SB_DIR = os.path.join(BASE_EP02, r"02_Storyboard")
OUT_DIR = os.path.join(BASE_EP02, r"04_Clips_Wan21_v2")
...
PLANOS = [
    ...
    {
        "id": 2,
        "name": "ep02_plano_02_v2.mp4",
        "raw_name": "wan21_raw_plano_02_v2.mp4",
    ...
    {
        "id": 3,
        "name": "ep02_plano_03_v2.mp4",
        "raw_name": "wan21_raw_plano_03_v2.mp4",
    ...
    {
        "id": 4,
        "name": "ep02_plano_04_v2.mp4",
        "raw_name": "wan21_raw_plano_04_v2.mp4",
    ...
    {
        "id": 5,
        "name": "ep02_plano_05_v2.mp4",
        "raw_name": "wan21_raw_plano_05_v2.mp4",
    ...
    {
        "id": 6,
        "name": "ep02_plano_06_v2.mp4",
        "raw_name": "wan21_raw_plano_06_v2.mp4",
    ...
    {
        "id": 7,
        "name": "ep02_plano_07_v2.mp4",
        "raw_name": "wan21_raw_plano_07_v2.mp4",
...
def poll_and_download(tasks):
    print("\n[*] Monitoreando renderizado de los 8 planos en DashScope Cloud...")
    completed_urls = {}
    pending = dict(tasks)
            ...
            try:
                ...
                if res.status_code == 200:
                    ...
                    if status == 'SUCCEEDED':
                        ...
                        print(f"[!] ERROR: Plano {pid} finalizó con {status}: {data}")
                        del pending[pid]
            except Exception as e:
                print(f"[!] Error consultando Plano {pid}: {e}")
    return completed_urls

def process_clips(completed_urls):
    print("\n[*] Descargando y procesando los 8 clips v2 con FFmpeg (1080p Cinematic)...")
...
if __name__ == "__main__":
    ...
    print(f"\n[+] Total de tareas despachadas exitosamente: {len(tasks)}/8")
    if len(tasks) == len(PLANOS):
        urls = poll_and_download(tasks)
        process_clips(urls)
        print("\n[OK] FASE 1 (Re-animación de los 8 clips v2 en 04_Clips_Wan21_v2) COMPLETADA.")
    else:
        print("[!] No se pudieron despachar todos los planos a DashScope.")
